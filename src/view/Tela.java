...
public class Tela extends JFrame {
    ...
    public Tela() {
        ...
        JComboBox cbProdutosConsultaTipo = new JComboBox();
        ...
        JList listaProdutosConsulta = new JList();
        ...
        ProdutoController prodCont = new ProdutoController(tfCadastroProdutosNome, tfCadastroProdutosValor, taProdutosCadastroDescricao, cbProdutosCadastroTipo, spProdutosCadastroQtd, tfProdutosCadastroCodigo);
        ...
        JList listaTiposConsultaTipos = new JList();
        ...
        JList listaTiposConsultaProdutos = new JList();
